    ...
    var e = {
                ...
                t(document).ready(function() {
                    ...
                    if (o) {
                        var d = t("#" + o),
                            l = d.offset().top;
                        t("html, body").animate({
                            scrollTop: t("[data-wpr-sticky-section=\"yes\"]").first().length ? l - t("[data-wpr-sticky-section=\"yes\"]").first().height() : l
                        }, a)
                    }
                    i.each(function() {
                        ...
                        t(this).click(function(e) {
                            ...
                            var r = t(this).find("a").attr("href"),
                                ...
                                n = s.offset().top;
                            t("html, body").animate({
                                scrollTop: t("[data-wpr-sticky-section=\"yes\"]").first().length ? n - t("[data-wpr-sticky-section=\"yes\"]").first().height() : n
                            }, a)
                        })
            ...
            widgetGrid: function(a) {
                    ...
                    "yes" !== u.find(".wpr-grid-media-wrap").attr("data-overlay-link") || e.editorCheck() || (u.find(".wpr-grid-media-wrap").css("cursor", "pointer"), u.find(".wpr-grid-media-wrap").on("click", function(e) {
                        ...
                        if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-grid-media-hover")) {
                            ...
                            var a = t(this).find(".wpr-grid-media-hover-bg").attr("data-url"),
                                a = a.replace("#new_tab", "");
                            "_blank" === u.find(".wpr-grid-item-title a").attr("target") ? window.open(a, "_blank").focus() : window.location.href = a
                        }
                    }))
                }
                ...
                function d(e, r = "") {
                    var s = a.find(".wpr-grid"),
                        ...
                        D, W, E, L, l;
                    "" != r && (n = r);
                    for (var B = a.attr("class"), B = B.split(" "), M = 0; M < B.length - 1; M++) - 1 !== B[M].search(/mobile\d/) && (m = B[M].slice(-1)), -1 !== B[M].search(/mobile_extra\d/) && (D = B[M].slice(-1)), -1 !== B[M].search(/tablet\d/) && (h = B[M].slice(-1)), -1 !== B[M].search(/tablet_extra\d/) && (W = B[M].slice(-1)), -1 !== B[M].search(/widescreen\d/) && (L = B[M].slice(-1)), -1 !== B[M].search(/laptop\d/) && (E = B[M].slice(-1));
                    ...
                    H >= A && null != G.mobile ? (w = m, u = v, y = b) : R >= A && null != G.mobile_extra ? (w = D ? D : h, u = _, y = x) : V >= A && null != G.tablet ? (w = h, u = C, y = k) : N >= A && null != G.tablet_extra ? (w = W ? W : h, u = T, y = S) : F >= A && null != G.laptop ? (w = E ? E : g, u = P, y = O) : U > A ? (w = g, u = e.gutter_hr, y = e.gutter_vr) : (w = L ? L : g, u = z, y = j), 8 < w && (w = 8), "string" == typeof w && -1 !== w.indexOf("pro") && (w = 3), q = s.width() + u - .3, n.outerWidth(Math.floor(q / w - u)), n.css("margin-bottom", y + "px"), 1 === w && n.last().css("margin-bottom", "0");
                    var X = -1;
                    if (o.each(function() {
                ...
                function h() {
                    a.find(".wpr-grid-filters").on("click", "span", function(e) {
                        ...
                        var i = t(this).data("filter"),
                            ...
                            n = r.attr("data-role"),
                            o, l;
                        "*" === t(this).data("filter") ? (o = "*", l = "*") : (o = t(this).data("ajax-filter")[0], l = t(this).data("ajax-filter")[1]), "parent" === n ? r.parent("ul").find("ul[data-parent=\"" + i + "\"]").length && (r.parent("ul").children("li").css("display", "none"), r.siblings("ul[data-parent=\"" + i + "\"]").css("display", "block")) : "back" === n && (r.closest(".wpr-grid-filters").children("li").css("display", "inline-block"), r.parent().css("display", "none")), a.find(".wpr-grid-filters span").removeClass("wpr-active-filter"), t(this).addClass("wpr-active-filter"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), u.isotopewpr("destroy"), a.find(".wpr-grid").html("<div class=\"wpr-grid-loader-wrap\"><div class=\"wpr-ring\"><div></div><div></div><div></div><div></div></div></div>"), console.log(+_.grid_settings.query_offset + a.find(".wpr-grid-item").length, l, o, _.grid_settings), t.ajax({
                            type: "POST",
                            url: WprConfig.ajaxurl,
                            data: {
                                action: y,
                ...
                function g() {
                    a.find(".wpr-load-more-btn").on("click", function(e) {
                        ...
                        t(window).scrollTop();
                        E.find(".wpr-load-more-btn").hide(), E.find(".wpr-pagination-loading").css("display", "inline-block"), t.ajax({
                            type: "POST",
                            url: WprConfig.ajaxurl,
                            data: {
                                action: y,
                            ...
                            success: function(e) {
                                ...
                                console.log(l, e.data.max_num_pages), t.ajax({
                                    type: "POST",
                                    url: WprConfig.ajaxurl,
                                    data: {
                                        action: v,
                                    ...
                                    success: function(e) {
                                        ...
                                        }), E.find(".wpr-pagination-loading").hide(), 1 < l ? "load-more" === _.pagination_type && E.find(".wpr-load-more-btn").fadeIn() : (E.find(".wpr-pagination-finish").fadeIn(1e3), E.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                            E.find(".wpr-pagination-loading").hide()
                                        }, 500)), n(_), u.data("lightGallery").destroy(!0), u.lightGallery(_.lightbox), s(), r(), p(), window.dispatchEvent(new Event("resize")), window.dispatchEvent(new Event("scroll"))
                                    },
                                    error: function(e) {
                                        console.log(e)
                                    }
                ...
                if (u.length) {
                    ...
                    if ("undefined" != typeof _ && !1 !== _) {
                        if (_ = JSON.parse(u.attr("data-settings")), a.find(".woocommerce-result-count").length) {
                            ...
                            var z = _.query_posts_per_page ? _.query_posts_per_page : parseInt(S);
                            if (isNaN(z) || 0 >= z) return;
                            var j = 1,
                                P = a.find(".wpr-grid-current-page");
                            P.length && (j = parseInt(P.text().trim()) || 1), 1 == P && S != a.find(".wpr-grid-item").length && (S = a.find(".wpr-grid-item").length);
                            var O = C.match(/(\d+)(?!.*\d+)/),
                        ...
                        if (u.on("arrangeComplete", function(e, i) {
                            ...
                            if (a.find(".wpr-grid-pagination").length && !e.editorCheck()) {
                                var E = a.find(".wpr-grid-pagination"),
                                    ...
                                    B = !1,
                                    M = !1;
                                "infinite-scroll" === _.pagination_type && (M = 300, B = L + " .wpr-load-more-btn"), u.infiniteScroll({
                                ...
                                u.on("load.infiniteScroll", function(e, i) {
                                    ...
                                    if (u.infiniteScroll("appendItems", o), u.isotopewpr("appended", o), o.imagesLoaded().progress(function() {
                                        ...
                                        }), E.find(".wpr-pagination-loading").hide(), _.pagination_max_pages - 1 === H) E.find(".wpr-pagination-finish").fadeIn(1e3), E.delay(2e3).fadeOut(1e3), setTimeout(function() {
                                        E.find(".wpr-pagination-loading").hide()
                                    }, 500);
                                    else if ("load-more" === _.pagination_type && (E.find(".wpr-load-more-btn").fadeIn(), a.find(".wpr-grid-filters").length && "*" !== a.find(".wpr-active-filter").attr("data-filter") && 0 < a.find(".wpr-active-filter").length)) {
            ...
            widgetAdvancedSlider: function(e) {
                ...
                if (n.slick({
                    ...
                    e.find(".slick-dots").length && e.find(".slick-dots").css("width", v), t(window).smartresize(function() {
                        setTimeout(function() {
